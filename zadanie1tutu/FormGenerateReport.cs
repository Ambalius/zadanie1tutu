...
using Font = iTextSharp.text.Font; // Библиотека для работы с PDF
...
namespace tutu
{
    ...
    {
        private string connectionString = "Host=localhost;Username=postgres;Password=123;Database=tutunaring";
